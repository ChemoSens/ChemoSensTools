...
(function (BingSpeech) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(this.authToken === "" || timeElapsed > 500)) return [3 /*break*/, 5];
                            newAuthToken = "";
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.makeHttpRequest("POST", "https://api.cognitive.microsoft.com/sts/v1.0/issueToken", false, optionalHeaders)];
                        case 2:
                            resultsText = _a.sent();
    ...
    var RecognitionClient = /** @class */ (function () {
        /**
        * @param apiKey should be your Bing Speech API key
        * Note: The way to get api key:
        * https://www.microsoft.com/cognitive-services/en-us/subscriptions?productId=/products/Bing.Speech.Preview
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this._tools.checkAuthToken()];
                        case 1:
                            _a.sent();
                            error = false;
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this._tools.makeHttpRequest("POST", "https://speech.platform.bing.com/recognize" + requestParameters, false, optionalHeaders, blob)];
                        case 3:
                            response = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, this._tools.makeHttpRequest("POST", "https://speech.platform.bing.com/synthesize", true, optionalHeaders, SSML)];
                        case 3:
                            blobReponse = _a.sent();
                            return [3 /*break*/, 5];
                        case 4:
